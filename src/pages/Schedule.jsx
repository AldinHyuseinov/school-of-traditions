    ...
    <main className="schedule">
      ...
      <section className="timetable">
        <div className="timetable-info">
          <p>
            Учебната седмица във „Фолклорна къща“ включва разнообразни дейности, които развиват
            умения чрез преживяване – народни танци, занаяти, традиционна кухня, разказване на
            приказки, работа с ръце и природа. Програмата е балансирана, динамична и ангажираща,
            като съчетава творчество, културно възпитание и личностно израстване в подкрепяща среда.
          </p>
